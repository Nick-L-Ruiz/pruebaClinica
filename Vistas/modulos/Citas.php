...
if($_SESSION["id"] != $valor = substr($_GET["url"], 6)){
	...
	<div class="modal-dialog">
		<div class="modal-content">
			  <div class="modal-header">
		        <h1 class="modal-title">Agendemos tu Cita</h1>
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<?php
                               ...
                               echo'<select name="nombreP" class="form-control input-lg" id="">
						...
						<div class="form-group">
							<input type="hidden" class="form-control input-lg" name="fyhIC" value="" readonly="" id="fyhIC">	
							<input type="hidden" class="form-control input-lg" name="fyhFC" value="" readonly="" id="fyhFC">							
						</div>
