...
<script>
  ...
  $('#calendar').fullCalendar({
    ...
    dayClick:function(date,jsEvent,view){
      ...
      var hora2 = ("01:00:00").split(":");//agregamos el tiempo entre consulta y consulta en este caso de una hora es decir inicia a las 11 termina a las 12, se ve marcado ese formato
      fecha = fecha.split("T");
      var dia = fecha[0];
      var hora = (fecha[1].split(":"));
      var horaEntera1 = parseFloat(hora[0]);
      var horaEntera2 = parseFloat(hora2[0]);

      var horaEnteraFinal = horaEntera1 + horaEntera2;
      $('#fechaC').val(dia);
      $('#horaC').val(horaEntera1+":00:00");
      $('#fyhIC').val(fecha[0]+" "+horaEntera1+":00:00");
      $('#fyhFC').val(fecha[0]+" "+horaEnteraFinal+":00:00");
    }
